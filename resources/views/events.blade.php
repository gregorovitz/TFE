...
@section('js')
    ...
    {!! $calendar_details->script() !!}
     {{--<script>--}}
         {{--$('#calendar-{{$calendar_details->getId()}}').fullCalendar({--}}
...
@section('content')
    <div class="container">
        <div class ="panel panel-primary">
            <div class ="panel-heading">Event calendat in Laravel 5 using Laravel-fullcalendar</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="formRegister" class="form-horizontal" role="form" method="POST" action="{{ url('/auth/register') }}">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">organisation,association</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="street number">
                                <small class="help-block"></small>
                            </div>
                        </div>
